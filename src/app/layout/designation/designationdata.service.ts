...
export class DesignationdataService {
    ...
    SERVER_URL: string = 'https://9876e87a.ngrok.io/api/Settings/GetDesignations';
    SERVER_URL_ADD: string ='https://9876e87a.ngrok.io/api/Settings/InsUpdateDesignation';

    SERVER_URL_DESG_DEL: string='https://9876e87a.ngrok.io/api/Settings/DeleteDesignation?DesignationId=';
